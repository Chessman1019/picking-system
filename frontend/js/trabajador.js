...
// =============================================
// RELOJ EN FORMATO 12 HORAS (PERÚ/LIMA)
// =============================================
function iniciarReloj() {
    function tick() {
        ...
        document.getElementById('fechaActual').textContent = ahora.toLocaleDateString('es-PE', {
            weekday: 'long',
            year: 'numeric',
            month: 'long',
            day: 'numeric',
...
async function cargarEstado() {
    try {
        ...
        if (data.activo && data.registro_activo) {
            ...
            const s = diff % 60;
            tiempo.textContent = `Tiempo transcurrido: ${h}h ${m}m ${s}s`;
        } else {
